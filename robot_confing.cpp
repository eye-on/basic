...
#include"vex.h"
//3,11,15,20
vex::motor motor_fr1=vex::motor(vex::PORT9,vex::ratio6_1,true);
vex::motor motor_fr2=vex::motor(vex::PORT8,vex::ratio6_1,false);

vex::motor motor_br1=vex::motor(vex::PORT6,vex::ratio6_1,true);
vex::motor motor_br2=vex::motor(vex::PORT7,vex::ratio6_1,false);

vex::motor motor_fl1=vex::motor(vex::PORT1,vex::ratio6_1,true);
vex::motor motor_fl2=vex::motor(vex::PORT2,vex::ratio6_1,false);

vex::motor motor_bl1=vex::motor(vex::PORT3,vex::ratio6_1,false);
vex::motor motor_bl2=vex::motor(vex::PORT5,vex::ratio6_1,true);
