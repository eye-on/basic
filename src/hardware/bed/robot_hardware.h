...
struct RobotHardware {
  ...
  RobotHardware()
      : bed_chassis(basic::chassis::bed_chassis_init({
            {{ // 左前 FL：2 电机（端口 9, 11）
                {vex::PORT9, vex::ratio6_1, true},   // TODO: 方向核对
                {vex::PORT19, vex::ratio6_1, true},
            }},
            {{ // 右前 FR：2 电机（端口 5, 6）
                {vex::PORT5, vex::ratio6_1, false},    // TODO: 方向核对
                {vex::PORT6, vex::ratio6_1, false},
            }},
            {{ // 左后 BL：2 电机（端口 7, 8）
                {vex::PORT7, vex::ratio6_1, true},   // TODO: 方向核对
                {vex::PORT8, vex::ratio6_1, true},
            }},
            {{ // 右后 BR：2 电机（端口 1, 2）
                {vex::PORT1, vex::ratio6_1, false},    // TODO: 方向核对
        ...
        // 吸球模块：3 电机开环定速，A 键边沿启停；未接线占位 20，
        // TODO: 接线后替换端口/正反/转速
        intake(basic::mechanism::intake_init({
            ...
            {vex::PORT20, vex::ratio6_1, false},  // TODO: 电机 C 端口/正反
