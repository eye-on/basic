...
constexpr std::array<int, kIndexedMotorCount> kLegacyIntakeSpeeds{{0, 0, -80, 40, -100, 80 ,-70}};
...
constexpr std::array<int, kIndexedMotorCount> kSortIntakeSpeeds{{0, 0, -80, 100, -100, 80 ,-100}};
